...
public class Authenticator {
	...
	public User authenticate(String username, String password) {
		...
		try {
			NodeList nodeList = this.getNodesFromDomDoc(XmlParser.parseDocument("C:\\Users\\KHEVLAR\\Downloads\\Telegram Desktop\\InventoryManagementSys-main\\InventoryManagementSys-main\\creds.xml"));
